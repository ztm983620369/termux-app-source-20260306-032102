...
object TermuxServiceExecLauncher {
    ...
    fun startTerminalSession(
        ...
        val bash = TermuxConstants.TERMUX_BIN_PREFIX_DIR_PATH + "/bash"
        val uri = Uri.Builder()
        ...
        val execIntent = Intent(TermuxConstants.TERMUX_APP.TERMUX_SERVICE.ACTION_SERVICE_EXECUTE, uri).apply {
            ...
            putExtra(TermuxConstants.TERMUX_APP.TERMUX_SERVICE.EXTRA_WORKDIR, workdir)
