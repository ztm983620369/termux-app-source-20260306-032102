...
import org.fossify.filemanager.databinding.FmActivitySettingsBinding
...
class SettingsActivity : SimpleActivity() {
    private val binding by viewBinding(FmActivitySettingsBinding::inflate)
    ...
    private fun setupCustomizeColors() {
        binding.settingsColorCustomizationHolder.setOnClickListener {
            startActivity(Intent(this, org.fossify.commons.activities.CustomizationActivity::class.java))
        }
    }
