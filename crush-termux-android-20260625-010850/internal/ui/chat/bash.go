...
func (b *BashToolRenderContext) RenderTool(sty *styles.Styles, width int, opts *ToolRenderOpts) string {
	...
	if meta.Background {
		...
		content := "命令: " + params.Command + "\n" + opts.Result.Content
		return renderJobTool(sty, opts, cappedWidth, "启动", meta.ShellID, description, content)
	}
	...
	if params.RunInBackground {
		toolParams = append(toolParams, "后台", "true")
	}
...
func (j *JobOutputToolRenderContext) RenderTool(sty *styles.Styles, width int, opts *ToolRenderOpts) string {
	cappedWidth := cappedMessageWidth(width)
	if opts.IsPending() {
		return pendingTool(sty, "任务", opts.Anim, opts.Compact)
	}
	...
	return renderJobTool(sty, opts, cappedWidth, "输出", params.ShellID, description, content)
}
...
func (j *JobKillToolRenderContext) RenderTool(sty *styles.Styles, width int, opts *ToolRenderOpts) string {
	...
	return renderJobTool(sty, opts, cappedWidth, "终止", params.ShellID, description, content)
}
