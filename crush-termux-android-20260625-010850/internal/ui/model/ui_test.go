...
func TestDefaultMouseMode(t *testing.T) {
	t.Setenv("CRUSH_MOUSE", "")
	t.Setenv("TERMUX_VERSION", "")

	require.Equal(t, tea.MouseModeCellMotion, defaultMouseMode())

	t.Setenv("TERMUX_VERSION", "0.118.3")
	require.Equal(t, tea.MouseModeCellMotion, defaultMouseMode())

	t.Setenv("CRUSH_MOUSE", "cell")
	require.Equal(t, tea.MouseModeCellMotion, defaultMouseMode())

	t.Setenv("CRUSH_MOUSE", "all")
	require.Equal(t, tea.MouseModeAllMotion, defaultMouseMode())

	t.Setenv("CRUSH_MOUSE", "off")
	require.Equal(t, tea.MouseModeNone, defaultMouseMode())
}
